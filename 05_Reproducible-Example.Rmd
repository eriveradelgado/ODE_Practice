...
the molecule can either diffuse(LIGAND) or it can react reversibly (COMPLEX) 
with a non-diffusing host. The resulting system of ode is solved with the method 
...
The model is used to simulate the cumulative release process out of the polymer. 
...
# At each time sum the concentration of free ligand and bound complex within the 
