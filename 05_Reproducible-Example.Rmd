...
# The LIGAND is free to diffuse. The HOST remains constant as it is part of the polymer matrix. 
# The LIGAND when inside the host forms the COMPLEX and is said to be bound
...
C_T = 1000000 * 0.008810573 / V_h # Host concentration inside polymer cylinder in mM (constant through time)
C_c = 0.0000001 * C_T             # Fraction of hosts without bound drug
...
LIGAND    <- c(rep((ligand_init / (N-1)), times = N-1), 0)  # Free LIGAND divided into the total number of layers, layer in direct contact to media is set to 0

COMPLEX   <- rep((complex_init / N), times = N)             # Complex divided into the total number of layers
